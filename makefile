#standard variables :CC-compiler, CCLINK-linker,CFLAGS-compilation flags, OBJS-object files, EXEC-the executable file  and RM-remove files for make clean command
CC=gcc
CCLINK=$(CC) # compiler is also linker
CFLAGS=-g -Wall -std=c99
OBJS=file0.o file1.o file2.o file3.o file4.o main.o
EXEC=prog.exe  
RM=rm -rf *.o *.exe 
#invoke(by default) executable file
$(EXEC): $(OBJS)
	$(CCLINK) $(OBJS) -o $(EXEC)
